...
export default function Assistant() {
  ...
  async function send() {
    ...
    try {
      ...
      setMessages((m) => [...m, { role: 'assistant', text: r.data.reply, suggestions: r.data.suggestions || [], source: r.data.source, reason: r.data.reason }])
    } catch (e) {
      ...
      {open && (
        <div style={styles.panel}>
          ...
          <div style={styles.inputRow}>
            <input value={input} onChange={e=>setInput(e.target.value)} placeholder="Ask me anything…" style={styles.input} onKeyDown={e=>{ if(e.key==='Enter') send() }} />
