    ...
    <div className="post-page">
      ...
      {post.coverUrl && (
        <div className="post-cover">
          <BlurImg src={post.coverUrl} alt="cover" className="post-cover-img" />
        </div>
      )}
      {toc.length > 0 && (
      ...
      <SaveDialog open={saveOpen} postId={post._id} postMeta={{ _id: post._id, slug: post.slug, title: post.title, coverUrl: post.coverUrl, tags: post.tags, publishedAt: post.publishedAt || post.createdAt, author: { username: post.author?.username } }} onClose={closeSave} />
